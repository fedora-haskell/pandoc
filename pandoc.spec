# generated by cabal-rpm-2.0.9 --standalone --stream hackage
# https://docs.fedoraproject.org/en-US/packaging-guidelines/Haskell/

%global pandoc_ver 2.10.1
%global pandoc_citeproc_ver 0.17.0.2
...
Patch:          pandoc-2.10.1-cabal.project.patch
...
BuildRequires:  happy
%else
# v1-update can't see recent pandoc?
BuildRequires:  cabal-install > 1.18
...
%if 0%{?fedora} >= 33
cabal install --disable-shared --installdir=%{buildroot}%{_bindir} --enable-executable-stripping -f "embed_data_files" exe:pandoc exe:pandoc-citeproc
%else
for pkg in pandoc-%{pandoc_ver} pandoc-citeproc-%{pandoc_citeproc_ver}; do
...
%changelog
* Mon May  3 2021 Jens Petersen <petersen@redhat.com> - 2.10.1-2
- update to pandoc-2.10.1

* Fri Apr 30 2021 Jens Petersen <petersen@redhat.com> - 2.9.2.1-1
- update to pandoc-2.9.2.1 and pandoc-citeproc-0.17.0.2

* Tue Jan 14 2020 Jens Petersen <petersen@redhat.com> - 2.9.1.1-1
- update to pandoc-2.9.1.1 and pandoc-citeproc-0.16.4.1
...
* Mon Mar 18 2019 Jens Petersen <petersen@redhat.com> - 2.7.1-1
- pandoc-2.7.1 and pandoc-citeproc-0.16.1.3

* Fri Dec  7 2018 Jens Petersen <petersen@redhat.com> - 2.5-1
- pandoc-2.5 and pandoc-citeproc-0.15.0.1

* Tue Nov  6 2018 Jens Petersen <petersen@redhat.com> - 2.4-1
- pandoc-2.4 and pandoc-citeproc-0.14.8
- always cabal update

* Tue Oct  2 2018 Jens Petersen <petersen@redhat.com> - 2.3.1-1
- pandoc-2.3.1 and pandoc-citeproc-0.14.5
